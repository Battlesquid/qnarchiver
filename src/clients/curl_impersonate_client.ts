import { BrowserPresets, BrowserType, ChromePresetVersion, CurlResultOk, FirefoxPresetVersion, getCompatibleBrowsers, RequestBuilder, RequestPreset, SafariPresetVersion } from "ts-curl-impersonate";
